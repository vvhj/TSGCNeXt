...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        self.l3  = TSGCNext_unit(base_channel, base_channel*2, A, adaptive=adaptive,drop_path=dp_rates[1])
        self.l4  = TSGCNext_unit(base_channel*2, base_channel*2, A, adaptive=adaptive,drop_path=dp_rates[2])
        self.l5  = TSGCNext_unit(base_channel*2, base_channel*2, A, adaptive=adaptive,drop_path=dp_rates[3])
